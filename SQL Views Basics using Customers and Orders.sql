...
select o.OrderNo as Order_Number,i.Price*o.[Quantity] as Price 
from [OrderDetails] as o inner join [Items] as i on i.ItemNo=O.ItemNo
...
select I.Name as ItemNO from ITEMS as I inner join (
select o.ItemNO as ItemNO,sum([ORDER].Total_Items_Ordered) as  Quantity from 
OrderDetails as o inner join [ORDER]  on o.OrderNo=[ORDER].OrderNo 
where Quantity>20
group by o.ItemNO ) as o on I.ItemNo=o.ItemNO

select*from GOODITEMS

--//////////////////////////////////q3///////////////////////////////////////

select p.Name from [Order] as o inner join CUSTOMERS as p on o.CustomerNo=p.CustomerNo
group by p.Name having sum(o.Total_Items_Ordered)>1
...
select s.Name from Customers as s where s.Phone is NOT NULL with check option
select*from Name1

--///////////////////////////////////q5//////////////////////////////////////
create view Name2 as
select s.Name from Customers as s where s.Phone is NOT NULL 
select*from Name2
